...
-- NS 11/27/2017: WP_fn_Get_Authors_String_By_ID_1
...
-- NS 2/23/2015 commented (revised on 11/27/2017)
--		Contrary to [WP_fn_Get_Authors_String_By_ItemID_2]
...
CREATE     FUNCTION [dbo].[WP_fn_Get_Authors_String_By_ID_1](@FSID1 INT, @ID BIGINT)
RETURNS VARCHAR(MAX)
AS
BEGIN
