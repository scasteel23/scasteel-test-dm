...
-- NS 11/22/2018: Made it just like 
--	DM_OUTLOOK_fn_Get_Facstaff_Addresses_Complete_Format1	function
CREATE FUNCTION [dbo].[DM_OUTLOOK_fn_Get_Facstaff_Addresses_Complete](@FSID INT, @ACode INT)
