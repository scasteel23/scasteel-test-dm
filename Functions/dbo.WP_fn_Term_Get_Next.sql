...
-- NS 7/17/2013
-- STC 9/28/17 - Return next fall/spring term (ignore summer/winter)
CREATE FUNCTION [dbo].[WP_fn_Term_Get_Next] 
(
	@term_cd VARCHAR(6)
)
RETURNS varchar(6)  AS  
BEGIN 
	DECLARE @next_term_cd varchar(6)
