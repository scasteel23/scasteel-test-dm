...
--NS 8/29/2014
--		Just replaced dbo.DIRECTORY_Employee_View  with Faculty_Staff_MIIS.dbo.Facstaff_Directory2 DV
--		Need to improve performance 
--			a) by simplify the search: not searching Facstaff_Basic, Facstaff_subunits, and Facstaff_Joint_Departments	more than one pass	
--			b) possibly put the information of JointDeptIND on Faculty_Staff_MIIS.dbo.Facstaff_Directory2 table
--			c) or a) and b)

--KA: June 2014
CREATE FUNCTION [dbo].[WWP_fn_Set_Joint_Dept_Ind_Table]
		(
