...
-- NS 11/22/2018: Make it the same with DM_OUTLOOK_fn_Get_Facstaff_Addresses_Complete_Format1 function
CREATE FUNCTION [dbo].[DM_OUTLOOK_fn_Get_Facstaff_Addresses_Street](@FSID INT, @ACode INT)
