...
[WEB_PROFILE_ORDER] [varchar] (10) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[lastModified] [datetime] NULL,
[Create_Datetime] [datetime] NULL,
[Download_Datetime] [datetime] NULL
) ON [PRIMARY]
GO
ALTER TABLE [dbo].[_DM_RESPROG] ADD CONSTRAINT [PK__DM_RESPROG] PRIMARY KEY CLUSTERED ([id]) ON [PRIMARY]
GO
