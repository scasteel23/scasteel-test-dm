CREATE TABLE [dbo].[_DM_DEG_COMMITTEE_TYPE]
(
[id] [bigint] NOT NULL,
[SEQ] [int] NOT NULL,
...
GO
ALTER TABLE [dbo].[_DM_DEG_COMMITTEE_TYPE] ADD CONSTRAINT [PK__DM_DEG_COMMITTEE_TYPE] PRIMARY KEY CLUSTERED ([id], [SEQ]) ON [PRIMARY]
GO
