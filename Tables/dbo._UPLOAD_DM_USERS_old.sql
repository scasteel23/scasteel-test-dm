CREATE TABLE [dbo].[_UPLOAD_DM_USERS_old]
(
...
[Update_Datetime] [datetime] NOT NULL CONSTRAINT [DF_UPLOAD_DM_USERS_old] DEFAULT (getdate())
) ON [PRIMARY]
GO
ALTER TABLE [dbo].[_UPLOAD_DM_USERS_old] ADD CONSTRAINT [PK_UPLOAD_DM_USERS_old] PRIMARY KEY CLUSTERED ([username]) ON [PRIMARY]
GO
