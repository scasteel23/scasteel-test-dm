CREATE TABLE [dbo].[_DM_SERVICE_ACADEMIC]
(
[userid] [bigint] NULL,
[id] [bigint] NOT NULL,
...
GO
ALTER TABLE [dbo].[_DM_SERVICE_ACADEMIC] ADD CONSTRAINT [PK__DM_SERVICE__ACADEMIC_PUBLIC] PRIMARY KEY CLUSTERED ([id]) ON [PRIMARY]
GO
