CREATE TABLE [dbo].[_DM_SERVICE_PROFESSIONAL]
(
[userid] [bigint] NULL,
[id] [bigint] NOT NULL,
...
[SCOPE_LOCALE] [varchar] (60) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
...
GO
ALTER TABLE [dbo].[_DM_SERVICE_PROFESSIONAL] ADD CONSTRAINT [PK__DM_SERVICE__PROFESSIONAL_PUBLIC] PRIMARY KEY CLUSTERED ([id]) ON [PRIMARY]
GO
