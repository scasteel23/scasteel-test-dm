...
CREATE VIEW [dbo].[DIRECTORY_Employee_View_All]
AS
...
Begin DesignProperties = 
   Begin PaneConfigurations = 
      Begin PaneConfiguration = 0
         NumPanes = 4
         Configuration = "(H (1[41] 4[16] 2[19] 3) )"
      End
   ...
   Begin CriteriaPane = 
      Begin ColumnWidths = 11
         ...
         Or = 1350
         Or = 1350
      ', 'SCHEMA', N'dbo', 'VIEW', N'DIRECTORY_Employee_View_All', NULL, NULL
GO
...
DECLARE @xp int
SELECT @xp=2
EXEC sp_addextendedproperty N'MS_DiagramPaneCount', @xp, 'SCHEMA', N'dbo', 'VIEW', N'DIRECTORY_Employee_View_All', NULL, NULL
GO
