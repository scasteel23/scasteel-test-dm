...
CREATE VIEW [dbo].[View_Import_INTELLCONT_Non_Journal_Types_No_Authors]
AS
...
Begin DesignProperties = 
   ...
   End
End
', 'SCHEMA', N'dbo', 'VIEW', N'View_Import_INTELLCONT_Non_Journal_Types_No_Authors', NULL, NULL
GO
DECLARE @xp int
SELECT @xp=1
EXEC sp_addextendedproperty N'MS_DiagramPaneCount', @xp, 'SCHEMA', N'dbo', 'VIEW', N'View_Import_INTELLCONT_Non_Journal_Types_No_Authors', NULL, NULL
GO
