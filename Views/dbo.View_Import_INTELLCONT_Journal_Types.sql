...
SET ANSI_NULLS ON
GO
CREATE VIEW [dbo].[View_Import_INTELLCONT_Journal_Types]
AS
...
Begin DesignProperties = 
   ...
   End
End
', 'SCHEMA', N'dbo', 'VIEW', N'View_Import_INTELLCONT_Journal_Types', NULL, NULL
GO
DECLARE @xp int
SELECT @xp=1
EXEC sp_addextendedproperty N'MS_DiagramPaneCount', @xp, 'SCHEMA', N'dbo', 'VIEW', N'View_Import_INTELLCONT_Journal_Types', NULL, NULL
GO
