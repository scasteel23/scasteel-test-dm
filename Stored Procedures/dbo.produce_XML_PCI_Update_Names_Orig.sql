...
-- NS 3/31/2019:
-- Reset PFNAME, FLNAME, PMNAME fom DM_Shadow_Staging.dbo._DM_PCI_For_Name_Update Where PCI_Empty_Pname='Yes'
...
CREATE PROC [dbo].[produce_XML_PCI_Update_Names_Orig] ( @submit BIT=0 )
AS
...
BEGIN
	...
	IF (SELECT COUNT(*) FROM DM_Shadow_Staging.dbo._DM_PCI_For_Name_Update WHERE PCI_Empty_Pname='Yes') > 0
