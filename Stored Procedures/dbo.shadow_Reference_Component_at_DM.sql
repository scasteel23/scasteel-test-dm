...
-- NS 10/16/2018
CREATE PROCEDURE [dbo].[shadow_Reference_Component_at_DM] 
AS 
BEGIN

	-- GET from
	-- https://www.digitalmeasures.com/login/service/v4/SchemaData:relaxng/INDIVIDUAL-ACTIVITIES-Business/INTELLCONT
	--  REPLACE <r:value dms:text=  WITH <journals name=
	--	REPLACE </r:value> WITH </journals>
	--
...
<journals name="Not in List">-1</journals>'
	...
	TRUNCATE TABLE dbo._DM_Reference_Component_at_DM

	INSERT INTO dbo._DM_Reference_Component_at_DM
		(Journal_Name, Journal_ID, Download_Datetime)
	...
	select * from dbo._DM_Reference_Component_at_DM
END
