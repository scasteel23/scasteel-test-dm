...
-- NS 9/7/2016 it worked for GET method, see _Test_WS SP
...
CREATE PROC [dbo].[_Test_Invoke_WS_v1]
(
      @URI varchar(2000) = '',      
...
as
	...
	BEGIN
		  ...
		  SELECT      hResult = convert(varbinary(4), @hResult), 
				source = @source, 
				description = @desc, 
				FailPoint = 'SetRequestHeader failed 1', 
				MedthodName = @methodName 
		  goto destroy 
		  return
	END
	-- NS 6/3/2016: Commented out
	-- set soap action 
	--
	...
	--			source = @source, 
	--			description = @desc, 
	--			FailPoint = 'SetRequestHeader failed 2', 
	--			MedthodName = @methodName 
	--	  goto destroy 
	--	  return
	--END
		...
		BEGIN
			...
			BEGIN
				  ...
				  SELECT      hResult = convert(varbinary(4), @hResult), 
						source = @source, 
						description = @desc, 
						FailPoint = 'SetRequestHeader failed 3', 
						MedthodName = @methodName 
				  goto destroy 
				  return
			END
