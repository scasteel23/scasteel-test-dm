...
-- NS 12/21/2018
--		Added ADMIN_PROG, ADMIN_NPRESP, ADMIN_EMPTYPE, ADMIN_EMPGROUP, ADMIN_TITLE
-- NS 11/7/2018
...
-- NS 9/18/2018: 
CREATE PROC [dbo].[_Decommissioned_produce_XML_ADMIN_Update_All] ( @submit BIT=0 )
AS
...
/*
	...
	There is a daily upload of new users to DM_Shadow_Staging.dbo._DM_USERS table
	 ...
	 EXEC dbo.[produce_XML_ADMIN_Update_All] @submit = 0
