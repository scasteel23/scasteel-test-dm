...
-- NS 7/5/2018
-- NS 7/3/2018
--		Copied from [_Test_2017] 
CREATE PROC [dbo].[_Test_2018]

AS

	-- Purposes of this SP is to run shadow individually per screen
	-- A) 7/3/2018: Need to test of many changes to variables to existing screens; or screen rename
	--			(CURRICULUM (formerly INNOVATION), AWARDHONOR, CONGRANT, EDUCATION,
	--			  INTELLCONT, LICCERT, MEMBER, PASTHIST, SERVICE_ACADEMIC, SERVICE_COMMITTEE, ...)
	-- B) 7/3/2018: Need to test new screens (FACDEV, MEDCONT, SERVICE, NCTEACH, SERVICE_PUBLIC, DEG_COMMITTEE, ...)
	...
	*/
	...
	-- 7/5/2018 
	--TRUNCATE TABLE [DM_Shadow_Staging].[dbo].[_DM_PASTHIST]
	--TRUNCATE TABLE [DM_Shadow_Production].[dbo].[_DM_PASTHIST]
	SELECT * FROM [DM_Shadow_Staging].[dbo].[_DM_PASTHIST]
	SELECT * FROM [DM_Shadow_Production].[dbo].[_DM_PASTHIST]
	EXEC dbo.webservices_initiate @screen='PASTHIST'	
	--RUN JOB - Digital Measures - Daily - Run DTSX
	...
	--RUN JOB - Digital Measures - Daily - Run DTSX
	EXEC msdb.dbo.sp_start_job 'Digital Measures - Daily - Run DTSX'
	...
	-- 7/5/2018 4:36 PM
	--TRUNCATE TABLE [DM_Shadow_Staging].[dbo].[_DM_NCTEACH]
	--TRUNCATE TABLE [DM_Shadow_Production].[dbo].[_DM_NCTEACH]
	SELECT * FROM [DM_Shadow_Staging].[dbo]._DM_NCTEACH
	SELECT * FROM [DM_Shadow_Production].[dbo]._DM_NCTEACH
	EXEC dbo.webservices_initiate @screen='NCTEACH'	
	--RUN JOB - Digital Measures - Daily - Run DTSX
	EXEC msdb.dbo.sp_start_job 'Digital Measures - Daily - Run DTSX'

	-- 7/6/2018 4:59 PM 
	--TRUNCATE TABLE [DM_Shadow_Staging].[dbo].[_DM_PROFILE]
	--TRUNCATE TABLE [DM_Shadow_Production].[dbo].[_DM_PROFILE]
	--TRUNCATE TABLE [DM_Shadow_Staging].[dbo].[_DM_PROFILE_LANGUAGES]
	--TRUNCATE TABLE [DM_Shadow_Production].[dbo].[_DM_PROFILE_LANGUAGES]
	SELECT * FROM [DM_Shadow_Staging].[dbo]._DM_PROFILE
	SELECT * FROM [DM_Shadow_Production].[dbo]._DM_PROFILE
	SELECT * FROM [DM_Shadow_Staging].[dbo]._DM_PROFILE_LANGUAGES
	SELECT * FROM [DM_Shadow_Production].[dbo]._DM_PROFILE_LANGUAGES
	EXEC dbo.webservices_initiate @screen='PROFILE'	
	EXEC msdb.dbo.sp_start_job 'Digital Measures - Daily - Run DTSX'
	--RUN JOB - Digital Measures - Daily - Run DTSX

	-- 7/6/2018 5:12 PM - ok ROLE need longer chars, now 1000
	--TRUNCATE TABLE [DM_Shadow_Staging].[dbo].[_DM_SERVICE_PUBLIC]
	--TRUNCATE TABLE [DM_Shadow_Production].[dbo].[_DM_SERVICE_PUBLIC]
	SELECT * FROM [DM_Shadow_Staging].[dbo].[_DM_SERVICE_PUBLIC]
	SELECT * FROM [DM_Shadow_Production].[dbo].[_DM_SERVICE_PUBLIC]
	EXEC dbo.webservices_initiate @screen='SERVICE_PUBLIC'	
	--RUN JOB - Digital Measures - Daily - Run DTSX
	EXEC msdb.dbo.sp_start_job 'Digital Measures - Daily - Run DTSX'

	-- 7/10/2018 5:12 PM - ok ROLE has longer chars, now 1000
	...
	-- 8/2/2018  3.52 PM
	/*
	TRUNCATE TABLE [DM_Shadow_Staging].[dbo].[_DM_MEDCONT]
	TRUNCATE TABLE [DM_Shadow_Production].[dbo].[_DM_MEDCONT_INTELLCONT_REF_DSA]
	TRUNCATE TABLE [DM_Shadow_Staging].[dbo].[_DM_MEDCONT]
	TRUNCATE TABLE [DM_Shadow_Production].[dbo].[_DM_MEDCONT_INTELLCONT_REF_DSA]
	*/
	SELECT * FROM [DM_Shadow_Staging].[dbo].[_DM_MEDCONT]
	SELECT * FROM [DM_Shadow_Staging].[dbo].[_DM_MEDCONT_INTELLCONT_REF_DSA]
	...
	*/
	...
	-- 8/3/2018  3.30 PM
	/*
	TRUNCATE TABLE [DM_Shadow_Staging].[dbo].[_DM_CURRICULUM]
	TRUNCATE TABLE [DM_Shadow_Production].[dbo].[_DM_CURRICULUM]
	*/
	SELECT * FROM [DM_Shadow_Staging].[dbo].[_DM_CURRICULUM] 
	SELECT * FROM [DM_Shadow_Production].[dbo].[_DM_CURRICULUM]
