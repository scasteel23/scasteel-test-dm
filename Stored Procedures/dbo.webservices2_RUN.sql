...
CREATE PROCEDURE [dbo].[webservices2_RUN]
	(
...
AS
	...
	*/
	...
	SET @base_url = 'https://webservices.digitalmeasures.com'
	...
	PRINT 'Processed requests : ' + CAST(@countreq as varchar) + ' records'
GO
