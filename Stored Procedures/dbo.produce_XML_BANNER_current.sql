...
CREATE PROC [dbo].[produce_XML_BANNER_current] ( @submit BIT=0 )
AS
...
BEGIN
	...
	*/
	...
	WHERE USERNAME IN (SELECT USERNAME FROM _DM_BANNER WHERE USERNAME is not NULL)		
	)
